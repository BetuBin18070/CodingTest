...
def get_args_parser():
    parser = argparse.ArgumentParser('DeiT for image classification', add_help=False)
    ...
    parser.add_argument('--output_dir', default='./output_dir/DeiT/baseline',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./runs/DeiT/baseline',
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if log_writer is not None:
            log_writer.add_scalar('DeiT/baseline/loss/val', val_epoch_loss, epoch)
            log_writer.add_scalar('DeiT/baseline/loss/train', train_epoch_loss, epoch)
            log_writer.add_scalar('DeiT/baseline/acc/val', val_epoch_acc, epoch)
            log_writer.add_scalar('DeiT/baseline/acc/train', train_epoch_acc, epoch)
            log_writer.flush()
